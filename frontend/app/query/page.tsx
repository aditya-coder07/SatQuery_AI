    ...
    <>
      <div className="shell">
        <header className="page-head">
          <Enter index={0}>
            <span className="label">Query console</span>
            <h1 className="page-title">Ask the imagery.</h1>
            <p className="page-lede">
              Attach one or two scenes - panchromatic, multispectral or SAR - and ask in
              plain language. The run streams every step; the answer arrives with its
              evidence, its checks and its calibrated doubt.
            </p>
          </Enter>
        </header>
