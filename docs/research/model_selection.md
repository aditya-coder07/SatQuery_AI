...
| grounding | LoRA r16 adapter (arm A) | v2 CNN (0.160, Category C) | **select** (arm B rejected 0.6736; arm C 0.6880 = arm A, McNemar n.s.; arm D running) | official test 0.6877 [0.677, 0.699] vs zero-shot 0.3823, McNemar p ≪ 0.001; 4-bit deployed path 0.678 (−1.0 pt, parity accepted) |
