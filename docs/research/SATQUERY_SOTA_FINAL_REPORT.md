...
| VRSBench val, grounding (16,159 refs) | Acc@0.5 | — | **0.6396** [0.632, 0.647] arm D′ (deployed); clean subset (no DIOR-RSVG-train source images, 11,316) 0.595; arm C 0.6325; arm A 0.501 | LLaVA-1.5-ft 51.2 / EarthDial 55.6 | +7 (clean) / +11 | — | A (official val) | bootstrap CI |
