...
| DIOR-RSVG test | Acc@0.5 | 0.160 (**Category C**: trained on the test split) | **0.6992** arm D (hard-negative retrain, McNemar significant); arm C 0.6880 deployed (+13 pts on VRSBench val); zero-shot 0.3823 | 83.4 LQVG / 77.7 GeoGround | +0.53 vs Phase 5 (+0.31 vs zero-shot) | +330% | A (Phase 6) | bootstrap 95% CI; McNemar 2,465 fixed / 174 broken, p ≪ 0.001 |
