...
| LEVIR-CD official test | change F1 / IoU | 0.855 / 0.747 | **0.9038 / 0.8244** (v3, best-val epoch 34; P 0.876 R 0.934; independently re-scored, CI [0.899, 0.908]; 0.9093 / 0.8336 at the val-selected threshold 0.8). **Served with dihedral TTA (2026-09-21): 0.9101 [0.906, 0.914] at 0.5; 0.9139 / 0.8414 at the val-selected 0.75** — same weights; a boundary-loss fine-tune (0.894) and a plain continuation (0.902) both fell below the champion | ChangeGCC 92.06 / 85.28; AGCD 90.34 / 82.38; BIT 89.3; ChangeFormer 90.4 | −6.5 (Phase 5) | **B** | ours: 256-px tiles of the official test, F1 on change class pixels; papers use the same tiling but some report on 512 px |
