...
| DIOR-RSVG official test | Acc@0.5 | 0.160 **(C — trained on test split, self-made subset)** | **0.6877** LoRA r16 arm A [0.677, 0.699] (zero-shot 0.3823; image-disjoint subset 0.805; **0.678 in the 4-bit deployed path**); arms B/C running | LQVG 83.4; LPVA 82.8; GeoGround 77.7; EarthGPT 76.7 | −15 (arm A) | **A** for Phase 6 | image-disjoint subset 0.4764 |
