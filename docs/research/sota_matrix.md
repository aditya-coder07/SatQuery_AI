...
| DIOR-RSVG official test | Acc@0.5 | 0.160 **(C — trained on test split, self-made subset)** | **0.6992** arm D (hard-negative retrain of arm A; McNemar vs arm A χ² 10.0, significant); arm A 0.6896 [0.677, 0.699]; arm C 0.6880 (deployed — +13 pts on VRSBench val); arm B 0.6736; unified 0.6379; zero-shot 0.3823; image-disjoint 0.805–0.813; 4-bit deployed path −1.0 pt | LQVG 83.4; LPVA 82.8; GeoGround 77.7; EarthGPT 76.7 | −13.4 (arm D) | **A** for Phase 6 | image-disjoint subset 0.4764 |
| VRSBench val, visual grounding (16,159 refs; CC-BY-4.0) | Acc@0.5 | — | **0.6325** [0.625, 0.640] arm C (arm A 0.501); clean subset (11,316 refs whose DIOR source is not in DIOR-RSVG train) **0.5863**; DOTA-only 0.5504 | VRSBench paper: LLaVA-1.5-ft 51.2, GeoChat-ft ~49.8, Mini-Gemini-ft 42.4; EarthDial 55.6 | +7 (clean) to +11 (full) | **A** (official val, same metric) — quote the clean subset when the adapter was trained on DIOR-RSVG train | arm C = arm A continued on DIOR-RSVG ×0.4 + VRSBench train grounding (quarantined) |
