...
| DIOR-RSVG official test | Acc@0.5 | 0.160 **(C — trained on test split, self-made subset)** | **0.7323** arm E (arm D′ + 1024² input; McNemar vs D′ χ² 47.1, significant; small objects 0.578) [≈0.722, 0.742]; arm D′ 0.7020 (deployed pending arm E's VRSBench check); arm D 0.6992; arm A 0.6896; arm C 0.6880; arm B 0.6736; unified 0.6379; zero-shot 0.3823; image-disjoint 0.840 | LQVG 83.4; LPVA 82.8; GeoGround 77.7; EarthGPT 76.7 | −10.1 (arm E) | **A** for Phase 6 | image-disjoint subset 0.4764 |
| VRSBench val, visual grounding (16,159 refs; CC-BY-4.0) | Acc@0.5 | — | **0.6396** [0.632, 0.647] arm D′ (deployed); arm C 0.6325; arm A 0.501; clean subset (11,316 refs whose DIOR source is not in DIOR-RSVG train) **0.5946** (arm C 0.5863); DOTA-only 0.5601 | VRSBench paper: LLaVA-1.5-ft 51.2, GeoChat-ft ~49.8, Mini-Gemini-ft 42.4; EarthDial 55.6 | +7 (clean) to +11 (full) | **A** (official val, same metric) — quote the clean subset when the adapter was trained on DIOR-RSVG train | arm C = arm A continued on DIOR-RSVG ×0.4 + VRSBench train grounding (quarantined) |
