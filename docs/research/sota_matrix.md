...
| DIOR-RSVG official test | Acc@0.5 | 0.160 **(C — trained on test split, self-made subset)** | **0.7020** arm D′ (deployed: arm A → +VRSBench → +hard negatives; McNemar vs arm C χ² 21.4, significant) [≈0.692, 0.712]; arm D 0.6992; arm A 0.6896 [0.677, 0.699]; arm C 0.6880; arm B 0.6736; unified 0.6379; zero-shot 0.3823; image-disjoint 0.817; 4-bit path −1.0 pt (arm A) | LQVG 83.4; LPVA 82.8; GeoGround 77.7; EarthGPT 76.7 | −13.2 (arm D′) | **A** for Phase 6 | image-disjoint subset 0.4764 |
