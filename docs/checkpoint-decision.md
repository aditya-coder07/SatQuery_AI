...
| P2 step | Status |
|---|---|
| 1. Commit the label-masking fix and its regression test | **DONE** — `14f8ac8`, "Supervise the answer, not 312 image placeholders per example", with `tests/test_vlm_label_masking.py`. The commit measures the defect precisely: 1,139 of 1,279 supervised tokens (89.1%) were `<|image_pad|>` |
...
Separately, **W16 is closed** (`2197fa3`): the six specialist heads now have
